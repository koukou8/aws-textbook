...
<table>
  ...
  <tbody>
    ...
    <tr><td>ビジネス</td><td><strong>24時間365日</strong>の電話・チャット・メール。本番システムのダウンは1時間以内の応答目標</td><td>本番ワークロードの運用</td></tr>
    <tr><td>エンタープライズ On-Ramp / エンタープライズ</td><td>ミッションクリティカル向け。最上位は15分以内の応答目標と専任のテクニカルアカウントマネージャー(TAM)</td><td>大規模・重要システム</td></tr>
  </tbody>
</table>
</div>
<p>なお、2025年12月に新しいサポートプラン体系(Business Support+・Enterprise Support・Unified Operations)への刷新が発表されており、上記の従来プランは2027年1月1日までの移行期間中も引き続き利用できます。</p>
